...
def build_memory_search_kernel(
    ...
    *,
    ...
    """Retain the legacy factory while routing memory through one adapter."""
    del per_source_timeout_s, side_effect_free
    memory_source = MemorySearchableSource(retrieval)
    ...
    return _MemorySearchKernelCompatibility(registry)
