...
def _direct_curator_prompt(
    *,
    ...
    return (
        ...
        "candidates. For a record flagged pure_transient_content, verify that no durable claim "
        "remains and archive it; for mixed_durability_content, rewrite or split it to preserve "
