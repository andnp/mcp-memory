...
DEFAULT_TASK_CLASS_BY_NAME = {
    ...
    CURATOR_FRONTIER_TASK_NAME: TASK_CLASS_DETERMINISTIC,
    GRAPH_LINK_DISCOVERY_TASK_NAME: TASK_CLASS_DETERMINISTIC,
    GRAPH_LINKER_TASK_NAME: TASK_CLASS_CHEAP_JSON,
    CONFLICT_SCREENING_TASK_NAME: TASK_CLASS_DETERMINISTIC,
    CONFLICT_DETECTOR_TASK_NAME: TASK_CLASS_CHEAP_JSON,
    DEDUP_PREP_TASK_NAME: TASK_CLASS_DETERMINISTIC,
    DEFRAGMENTER_TASK_NAME: TASK_CLASS_CHEAP_JSON,
    TAG_NORMALIZER_TASK_NAME: TASK_CLASS_DETERMINISTIC,
