...
def create_runtime_composition(
    ...
    *,
    ...
    context = ApplicationContext(
        ...
        ingress_batch_evidence=storage.ingress_batch_evidence,
        ingress_action_receipts=storage.ingress_action_receipts,
        source_coverage=storage.source_coverage,
        ingress_quality_evidence=storage.ingress_quality_evidence,
        ingress_mutation_transaction=storage.ingress_mutation_transaction,
...
def _runtime_resources_from_context(context: ApplicationContext) -> RuntimeResources:
    ...
    return RuntimeResources(
        storage=StorageBackendResources(
            ...
            ingress_batch_evidence=context.ingress_batch_evidence,
            ingress_action_receipts=context.ingress_action_receipts,
