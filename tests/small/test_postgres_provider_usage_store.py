    ...
    def execute(self, query: str, params: tuple[object, ...] | None = None) -> None:
            ...
            self._state.provider_usage.append(
                {
                    ...
                    "curation_packet_id": arguments[4],
                    "request_id": arguments[5],
                    "attempt": arguments[6],
                    "attempt_identity": arguments[7],
                    "subprocess_pid": arguments[8],
                    "provider_key": arguments[9],
                    "provider_name": arguments[10],
                    "model_name": arguments[11],
                    "status": arguments[12],
                    "duration_seconds": arguments[13],
                    "created_at": arguments[14],
                    "error_text": arguments[15],
                    "reason_category": arguments[16],
                    "reason_code": arguments[17],
                    "retry_delay_seconds": arguments[18],
                    "input_tokens": arguments[19],
                    "output_tokens": arguments[20],
                    "cached_input_tokens": arguments[21],
                    "cache_write_tokens": arguments[22],
                    "reasoning_tokens": arguments[23],
                    "total_tokens": arguments[24],
                    "token_usage_source": arguments[25],
                }
            )
            return
        if normalized.startswith("INSERT INTO ai_conversations"):
            ...
            payload = {
                ...
                "task_id": arguments[4],
                "curation_packet_id": arguments[5],
                "provider_key": arguments[6],
                "provider_name": arguments[7],
                "model_name": arguments[8],
                "subprocess_pid": arguments[9],
                "prompt_text": arguments[10],
                "response_text": arguments[11],
                "parsed_json": arguments[12],
                "status": arguments[13],
                "error_text": arguments[14],
                "reason_category": arguments[15],
                "reason_code": arguments[16],
                "retry_delay_seconds": arguments[17],
                "started_at": arguments[18],
                "completed_at": arguments[19],
                "duration_seconds": arguments[20],
                "input_tokens": arguments[21],
                "output_tokens": arguments[22],
                "cached_input_tokens": arguments[23],
                "cache_write_tokens": arguments[24],
                "reasoning_tokens": arguments[25],
                "total_tokens": arguments[26],
                "token_usage_source": arguments[27],
            }
            if existing is None:
...
def test_postgres_provider_usage_repository_preserves_execution_attribution() -> None:
    ...
    assert row["curation_packet_id"] == "packet-9"
